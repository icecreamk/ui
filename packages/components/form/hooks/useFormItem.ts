...
export default function useFormItem({
  ...
  const createInputNumberRange = (
    prop,
    label,
    { attrs = {}, events = {}, customCollAttrs = {}, hideLabel = false } = {}
  ) => {
    return {
      hideLabel,
      colAttrs: {
  ...
  const createItemList = (
    list: any = [],
    { customCollAttrs = {}, hideLabel = true, uid = idGenerator() } = {}
  ) => {
    return {
      uid,
      colAttrs: {
