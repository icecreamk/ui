import { openBlock, createElementBlock, createElementVNode, renderSlot, resolveComponent, resolveDirective, Fragment, renderList, withDirectives, createBlock, mergeProps, defineComponent, ref, withCtx, createVNode, createCommentVNode, unref, resolveDynamicComponent, createSlots, toDisplayString, createTextVNode, useSlots, useAttrs, watch, vShow } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(true), createElementBlock(Fragment, null, renderList(__props.columns, col => {
        return withDirectives((openBlock(), createBlock(_component_el_table_column, mergeProps({
  ...
  setup(__props, {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [withDirectives((openBlock(), createBlock(_component_el_table, mergeProps({
        ...
        default: withCtx(() => [renderSlot(_ctx.$slots, "expand"), createVNode(script$4, {
...
export { AsButton, AsForm, AsTable };
