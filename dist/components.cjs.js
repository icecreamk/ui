...
var script$5 = /*@__PURE__*/Object.assign({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$3, [vue.createElementVNode("button", null, [vue.renderSlot(_ctx.$slots, "default")])]);
    };
  }
});
...
var script$4 = /*@__PURE__*/Object.assign({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      const _directive_slots = vue.resolveDirective("slots");
      return vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.columns, col => {
        return vue.withDirectives((vue.openBlock(), vue.createBlock(_component_el_table_column, vue.mergeProps({
          "show-overflow-tooltip": "",
          key: col.uid || col.prop,
          ref_for: true
        }, getColAttrs(col)), null, 16 /* FULL_PROPS */)), [[_directive_slots, col.slots]]);
      }), 128 /* KEYED_FRAGMENT */);
    };
  }
});
...
var script$3 = /*@__PURE__*/Object.assign({
  ...
  setup(__props, {
    ...
    const props = __props;
    const emits = __emit;
    const tableUid = vue.ref(Math.random());
    const loading = vue.ref(false);
    const selectedRows = vue.ref([]);
    const tableList = vue.ref(props.initData || []);
    ...
    const refreshTable = async ({
      ...
      try {
        loading.value = true;
        const curParams = props.getTableParams && props.getTableParams() || {};
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$2, [vue.withDirectives((vue.openBlock(), vue.createBlock(_component_el_table, vue.mergeProps({
        border: true,
        ...
        _: 3 /* FORWARDED */
      }, 16 /* FULL_PROPS */, ["data"])), [[_directive_loading, loading.value]]), __props.showPagination ? (vue.openBlock(), vue.createBlock(_component_el_pagination, {
        key: 0,
        style: {
          "display": "flex",
        ...
        onCurrentChange: handlePageNoChange,
        "current-page": pageInfo.value.pageNo,
        "page-sizes": [10, 20, 30, 50, 100],
        "page-size": pageInfo.value.pageSize,
        layout: "total, prev, pager, next, sizes",
        total: pageInfo.value.totalNum
      }, null, 8 /* PROPS */, ["current-page", "page-size", "total"])) : vue.createCommentVNode("v-if", true)]);
    };
  }
});
...
var script$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [vue.createElementVNode("div", _hoisted_1$1, [vue.createVNode(_component_el_input_number, vue.mergeProps({
        modelValue: vue.unref(proxys)[prop_start],
        "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => vue.unref(proxys)[prop_start] = $event)
      }, getCompAttrs(__props.info)), null, 16 /* FULL_PROPS */, ["modelValue"]), _cache[2] || (_cache[2] = vue.createElementVNode("span", {
        style: {
          "text-align": "center"
        }
      }, "--", -1 /* HOISTED */)), vue.createVNode(_component_el_input_number, vue.mergeProps({
        modelValue: vue.unref(proxys)[prop_end],
        "onUpdate:modelValue": _cache[1] || (_cache[1] = $event => vue.unref(proxys)[prop_end] = $event)
      }, getCompAttrs(__props.info)), null, 16 /* FULL_PROPS */, ["modelValue"])]), _cache[3] || (_cache[3] = vue.createElementVNode("span", {
        style: {
          "padding": "0 5px"
        }
      }, "ms", -1 /* HOISTED */))], 64 /* STABLE_FRAGMENT */);
    };
  }
};
  ...
  setup(__props) {
    ...
    const getItemListEvents = ({
      ...
      Object.keys(events).forEach(key => {
        ...
        newEvents[key] = collectArguments(func, {
          uid,
          idx
        });
      });
    ...
    const getCompAttrs = (value, {
      uid = "-1",
      idx = 0
    } = {}) => {
      return {
        ...omit(value.inner, ["is", "childIs", "children", "hideLabel", "slots", "rules", "event"]),
        ...getItemListEvents({
          uid,
          idx
        }, value.events)
    ...
    return (_ctx, _cache) => {
      const _component_form_item = vue.resolveComponent("form-item", true);
      const _component_el_col = vue.resolveComponent("el-col");
      const _component_el_row = vue.resolveComponent("el-row");
      const _component_el_form_item = vue.resolveComponent("el-form-item");
      return vue.unref(isArray)(__props.info) ? (vue.openBlock(), vue.createBlock(_component_el_row, {
        key: 0
      }, {
        default: vue.withCtx(() => [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(__props.info, (item, listIdx) => {
          return vue.openBlock(), vue.createBlock(_component_el_col, vue.mergeProps({
            key: item.prop,
            ref_for: true
          }, vue.unref(getColAttrs)(item)), {
            default: vue.withCtx(() => [vue.createCommentVNode(" {{ listIdx }}\"listIdx\"\n      {{ pIdx }} "), vue.unref(isArray)(item.list) ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, {
              key: 0
            }, vue.renderList(item.list, (child, idx) => {
              return vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(getCompType(child)), vue.mergeProps({
                key: idx,
                ref_for: true
              }, getCompAttrs(child, {
                uid: item.uid,
                ...
                _: 2 /* DYNAMIC */
              }, [child.slots && child.slots.default ? {
                name: "default",
                fn: vue.withCtx(scope => [vue.createCommentVNode(" <ColumSlot :slots=\"child.slots.default\" :scope=\"scope\" /> ")]),
                key: "0"
              } : undefined]), 1040 /* FULL_PROPS, DYNAMIC_SLOTS */);
            }), 128 /* KEYED_FRAGMENT */)) : (vue.openBlock(), vue.createBlock(_component_form_item, {
              key: 1,
              pIdx: listIdx,
              info: item,
              myForm: __props.myForm,
              formItemRef: __props.formItemRef
            }, null, 8 /* PROPS */, ["pIdx", "info", "myForm", "formItemRef"]))]),
            _: 2 /* DYNAMIC */
          }, 1040 /* FULL_PROPS, DYNAMIC_SLOTS */);
        }), 128 /* KEYED_FRAGMENT */))]),
        _: 1 /* STABLE */
      })) : __props.info.slot ? vue.renderSlot(_ctx.$slots, __props.info.slot, {
        key: 1
      }) : (vue.openBlock(), vue.createBlock(_component_el_form_item, vue.mergeProps({
        key: 2
      }, getFormItemAttrs(__props.info), {
        ref: __props.formItemRef[__props.uKey]
      }), {
        label: vue.withCtx(() => [vue.createElementVNode("span", null, vue.toDisplayString(__props.info.hideLabel === true ? "" : __props.info.label), 1 /* TEXT */)]),
        default: vue.withCtx(() => [(vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(getCompType(__props.info)), vue.mergeProps({
          modelValue: vue.unref(proxys)[__props.info.prop],
          "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => vue.unref(proxys)[__props.info.prop] = $event)
        }, getCompAttrs(__props.info), {
          info: __props.info,
          getCompAttrs: getCompAttrs,
          myForm: __props.myForm
        }), vue.createSlots({
          default: vue.withCtx(() => [__props.info.inner.children ? (vue.openBlock(true), vue.createElementBlock(vue.Fragment, {
            key: 0
          }, vue.renderList(__props.info.inner.children, cItem => {
            return vue.openBlock(), vue.createBlock(vue.resolveDynamicComponent(getChildCompType(__props.info)), vue.mergeProps({
              key: cItem.value,
              ref_for: true
            }, vue.unref(omit)(cItem, ['is'])), null, 16 /* FULL_PROPS */);
          }), 128 /* KEYED_FRAGMENT */)) : vue.createCommentVNode("v-if", true)]),
          _: 2 /* DYNAMIC */
        }, [__props.info.slots && __props.info.slots.suffix ? {
          name: "suffix",
          fn: vue.withCtx(() => [vue.createTextVNode(vue.toDisplayString(__props.info.slots.suffix), 1 /* TEXT */)]),
          key: "0"
        } : undefined]), 1040 /* FULL_PROPS, DYNAMIC_SLOTS */, ["modelValue", "info", "myForm"]))]),
        _: 1 /* STABLE */
      }, 16 /* FULL_PROPS */));
    };
  }
...
var script = /*@__PURE__*/Object.assign({
  ...
  setup(__props, {
    ...
    // }>();
    const formItemRef = {};
    const newItemList = vue.ref({});
    const allRowInfos = vue.ref({});
    const slots = vue.useSlots();
    vue.useAttrs();
    const baseFormRef = vue.ref();
    ...
    const genNewItemForm = () => {
      ...
      const list = cloneItems.map((originItem, rowIdx) => {
        ...
        const newFormItem = vue.ref({});
        newFormItem.value = {
          ...formItem
        };
        createNewItemForm(formItemRef, myProp.form, newFormItem, formItem, slots, keys);
        rowAttrsList[rowIdx] = originItem["rowAttrs"] || {
          gutter: 10
        };
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [vue.createVNode(_component_el_form, vue.mergeProps({
        model: myProp.form,
        ref_key: "baseFormRef",
        ref: baseFormRef
      }, getFormAttrs(), {
        ...
        default: vue.withCtx(() => [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(newItemList.value, (fItem, rIdx) => {
          return vue.openBlock(), vue.createBlock(_component_el_row, vue.mergeProps({
            ref_for: true
          }, getRowAttrs(rIdx), {
            key: rIdx
          }), {
            default: vue.withCtx(() => [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(getColItem(fItem), ([key, info]) => {
              return vue.withDirectives((vue.openBlock(), vue.createBlock(_component_el_col, vue.mergeProps({
                key: key,
                ref_for: true
                ...
                }, null, 8 /* PROPS */, ["info", "myForm"]))]),
                _: 2 /* DYNAMIC */
              }, 1040 /* FULL_PROPS, DYNAMIC_SLOTS */)), [[vue.vShow, !info.colAttrs.hidden]]);
            }), 128 /* KEYED_FRAGMENT */))]),
            _: 2 /* DYNAMIC */
          }, 1040 /* FULL_PROPS, DYNAMIC_SLOTS */);
        }), 128 /* KEYED_FRAGMENT */))]),
